...
int main(void) {
    ...
    */
    ...
    int *pointer = NULL;
    pointer = &x;       //guardo la direccion a la que quiero apuntar
    *pointer = 9;       //cambio el valor que hay dentro de esa direccion por la expresion

    pointer = &m.age;
    *pointer = 100;

    char *charpointer = NULL;
    charpointer = &m.name_initial;
    *charpointer = 'F';
